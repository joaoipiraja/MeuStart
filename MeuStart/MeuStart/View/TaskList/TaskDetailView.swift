...
#Preview {
    TaskDetailView(item: .constant(
        ChecklistItem(
            title: "Ler o manual da empresa",
            details: .init(markdown: sampleMarkdown,
                           actionTitle: "Abrir manual",
                           actionURL: URL(string: "https://empresa.com/manual"))
        )
    ))
}
